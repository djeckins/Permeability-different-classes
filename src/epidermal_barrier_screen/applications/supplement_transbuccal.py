"""Supplement (Transbuccal) prediction module.

Contains the complete screening logic for supplement transbuccal applications.
...
# ---------------------------------------------------------------------------
# Scoring configuration  —  Supplement (Transbuccal)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Main prediction function  —  Supplement (Transbuccal)
# ---------------------------------------------------------------------------

def predict_supplement_transbuccal(records: list[dict[str, Any]], ph: float = PH_SC) -> pd.DataFrame:
    """Screen molecules for supplement (transbuccal) application.
