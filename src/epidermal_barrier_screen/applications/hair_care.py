"""Hair care prediction module.

Contains the complete screening logic for hair care applications.
...
# ---------------------------------------------------------------------------
# Scoring configuration  —  Hair care
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Main prediction function  —  Hair care
# ---------------------------------------------------------------------------

def predict_hair_care(records: list[dict[str, Any]], ph: float = PH_SC) -> pd.DataFrame:
    """Screen molecules for hair care application.
