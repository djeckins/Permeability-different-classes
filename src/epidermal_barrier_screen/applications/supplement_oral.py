"""Supplement (Oral) prediction module.

Contains the complete screening logic for supplement oral applications.
...
# ---------------------------------------------------------------------------
# Main prediction function  —  Supplement (Oral)
# ---------------------------------------------------------------------------

def predict_supplement_oral(records: list[dict[str, Any]], ph: float = PH_SC) -> pd.DataFrame:
    """Screen molecules for supplement (oral) application.
